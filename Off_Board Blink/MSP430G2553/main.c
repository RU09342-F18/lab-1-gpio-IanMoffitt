#include <msp430.h> 
/**
 * This is the fourth assignment, Off Board Blink
 * I am re-using the same code as Multiple blink, so I will be connecting the LEDs to the same ports as described here
 * main.c
 */
int main(void)
{
